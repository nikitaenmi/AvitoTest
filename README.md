...
- [Описание задачи и реализация сервиса](#описание-задачи-и-реализация-сервиса)
...
- Из дополнительных задач реализовано Е2Е тестирование, нагрузочное тестирование и описание конфигурации линтера

### Описание работы сервиса

- Сервис принимает запросы пользователя

- Методы, ответы и коды HTTP полностью соответсвуют API
